<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:94:"D:\ProgramFiles\php\PHPTutorial\WWW\hntravel\public/../application/admin\view\index\index.html";i:1527005081;s:84:"D:\ProgramFiles\php\PHPTutorial\WWW\hntravel\application\admin\view\common\meta.html";i:1527005081;s:86:"D:\ProgramFiles\php\PHPTutorial\WWW\hntravel\application\admin\view\common\header.html";i:1527005081;s:84:"D:\ProgramFiles\php\PHPTutorial\WWW\hntravel\application\admin\view\common\menu.html";i:1527005081;s:87:"D:\ProgramFiles\php\PHPTutorial\WWW\hntravel\application\admin\view\common\control.html";i:1527005081;s:86:"D:\ProgramFiles\php\PHPTutorial\WWW\hntravel\application\admin\view\common\script.html";i:1527005081;}*/ ?>
<!DOCTYPE html>
...
<nav class="navbar navbar-static-top">
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <!-- <li>
                <a href="/hntravel/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
            </li> -->
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="/hntravel/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                    <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                </a>
                <ul class="dropdown-menu">
                    <!-- User image -->
                    <li class="user-header">
                        <img src="/hntravel/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/hntravel/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
...
<!-- /.sidebar -->
        ...
        <footer class="main-footer hide">
            ...
            <strong>Copyright &copy; 2017-2018 <a href="#">LiangDaojing</a>.</strong> All rights reserved.
        </footer>
